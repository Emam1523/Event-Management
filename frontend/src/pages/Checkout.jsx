...
const Checkout = () => {
  ...
  const requiresCheckoutVerification = Boolean(
    user?.email &&
  ...
  useEffect(() => {
    if (
      ...
      authAPI
        .requestVerificationCode({ email: user.email, purpose: "checkout" })
        .catch(() => {});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.paymentMethod === "amarPay") {
        const { data } = await paymentAPI.initiateAmarPay({
    ...
    <div className="min-h-screen bg-aurora py-8 md:py-12">
      <div className="container-custom">
        <div className="mb-6">
          <Link
            to="/cart"
            className="inline-flex items-center text-zinc-600 hover:text-zinc-900 transition-colors text-sm font-semibold"
          >
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-zinc-600">
                Review your details and confirm your booking in one step.
              </p>
            </div>
          ...
          <div className="lg:col-span-2 space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-slate-300 bg-white py-3 pl-10 pr-3 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-slate-200"
                      required
                    />
                  </div>
                </div>
                ...
                {awaitingEmailVerification && (
                  <div className="mt-5 rounded-2xl border border-amber-200 bg-amber-50 p-4">
                    ...
                    <p className="text-xs text-amber-800 mb-3">
                      Enter the 6-digit code sent to {formData.email} to
                    ...
                    <input
                      ...
                      placeholder="123456"
                      className="w-full rounded-xl border border-amber-200 bg-white px-4 py-3 text-center text-xl font-black tracking-[0.35em] text-zinc-900 outline-none"
                      maxLength={6}
                    />
                  </div>
                )}
            ...
            <form onSubmit={handleSubmit}>
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-7 mb-6">
                <h2 className="text-lg font-bold text-zinc-900 mb-5 flex items-center">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-slate-300 bg-white py-3 px-3 text-sm text-zinc-900 outline-none focus:ring-2 focus:ring-slate-200"
                        maxLength={19}
                        required
                      />
                    </div>
                ...
                {formData.paymentMethod === "amarPay" && (
                  <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
                    You will be redirected to amarPay secure payment page to
              ...
              <div className="flex items-start bg-emerald-50 border border-emerald-100 rounded-2xl p-4 mb-6">
                <FiLock className="text-emerald-600 text-lg mr-3 mt-0.5 shrink-0" />
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sticky top-24">
              ...
              <div className="space-y-3 border-t pt-4">
                ...
                <div className="flex justify-between text-base font-bold text-zinc-900 pt-2 border-t">
                  <span>Total</span>
                ...
                <div className="flex flex-wrap gap-2">
                  {["Visa", "Mastercard", "amarPay", "bKash", "Nagad"].map(
                    (m) => (
                      <span
                        key={m}
                        className="px-2 py-1 bg-slate-100 rounded text-xs text-zinc-600"
                      >
                        {m}
                      </span>
                    ),
