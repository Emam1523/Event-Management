      ...
      <section className="py-10">
        <div className="container-custom">
          <div className="bg-white/5 border border-white/10 rounded-4xl p-10 md:p-14 card-glow">
            <div className="text-xs font-black uppercase tracking-wider text-brand-orange mb-4">
              Introduction
            </div>
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tight mb-4">
              What is NEXTDHAKA?
            </h2>
            <p className="text-zinc-400 text-lg font-light leading-relaxed max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {steps.map((step, i) => (
              <motion.div
                ...
                className="relative flex flex-col items-center text-center bg-white/5 border border-white/10 rounded-4xl p-10 card-glow hover:-translate-y-2 transition-all duration-300 hover:border-brand-primary/70 hover:bg-brand-secondary/10"
              >
                <div
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {analyticsItems.map((item, index) => (
                <motion.div
                  ...
                  className="rounded-3xl border border-white/10 bg-white/3 p-5 card-glow flex items-center gap-4 hover:border-brand-primary/70 transition-colors duration-250"
                >
                  ...
                  <p className="text-sm xl:text-lg font-normal leading-snug text-zinc-100">
                    {item.title}
                  </p>
                </motion.div>
              ))}
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-5">
            {paymentItems.map((item, index) => (
              <motion.div
                ...
                className="rounded-xl border border-white/10 bg-white/3 p-6 md:p-7 card-glow min-h-56 flex flex-col justify-start group hover:-translate-y-2 transition-all duration-300 hover:border-brand-primary/70"
              >
                <div className="flex items-start justify-between gap-4 mb-6">
                  <div className="h-14 w-14 rounded-2xl border border-primary/20 bg-primary/12 text-primary grid place-items-center text-2xl group-hover:scale-110 mx-auto transition-transform ease-in">
                    {item.icon}
                  </div>
                </div>
                <div>
