...
const PaymentSuccess = () => {
  ...
  const bookingDate = booking?.event?.date
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              <h3 className="font-bold text-gray-900 mb-2">
                {booking?.event?.title || "Booking confirmed"}
              </h3>
              <div className="space-y-1 text-sm text-gray-600">
                <p>
                  📅{" "}
                  {bookingDate ? bookingDate.toLocaleDateString() : "Date TBA"}
                </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>Next steps:</strong> Check your email for the ticket
                confirmation. Bring a valid ID and show your QR code at the
                venue entrance.
              </p>
            </div>
