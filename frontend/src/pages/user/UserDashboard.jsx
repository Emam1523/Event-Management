  ...
  const fetchUserData = useCallback(async () => {
    try {
      ...
      const upcoming = bookings.filter(
        (b) => isAfter(new Date(b.event.date), now) && b.status === "confirmed",
      );
      const past = bookings.filter(
        (b) =>
          !isAfter(new Date(b.event.date), now) || b.status === "cancelled",
      );
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden rounded-[3rem] bg-zinc-950 border border-white/5 p-8 sm:p-16 group">
        ...
        <div
          className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-brand-secondary/10 rounded-full -ml-40 -mb-40 blur-[100px] animate-pulse-slow"
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-12">
          <div className="flex-1 space-y-8">
            ...
            >
              ...
              <span className="text-brand-orange text-[11px] font-black uppercase tracking-[0.3em]">
                NEXTDHAKA Live
              </span>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h1 className="text-5xl sm:text-7xl font-black text-white tracking-tighter leading-[0.95]">
                Welcome Back, <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-brand-orange via-brand-secondary to-brand-orange bg-[length:200%_auto] animate-gradient-x">
                  {user?.name?.split(" ")[0]}
                </span>
              </h1>
              <p className="text-zinc-500 text-xl max-w-xl leading-relaxed font-medium">
                Your premium access hub. You currently have{" "}
                <span className="text-white font-bold">
                  {stats.upcomingEvents} exclusive events
                </span>{" "}
                lined up.
              </p>
            </motion.div>
            ...
            >
              <Link
                to="/events"
                className="px-10 py-5 bg-brand-orange text-white rounded-3xl font-black uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-brand-orange/20 flex items-center gap-3"
              >
          ...
          >
            <div className="w-56 h-56 rounded-[3rem] bg-linear-to-br from-white/5 to-transparent border border-white/10 flex items-center justify-center relative group/icon overflow-hidden">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
        {statCards.map((card) => (
          ...
          >
            <div
              className={`absolute inset-0 bg-linear-to-br ${card.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
            />

            <div
              className={`w-16 h-16 rounded-3xl bg-zinc-900 border border-white/5 flex items-center justify-center text-3xl ${card.iconColor} group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 relative z-10 shadow-inner`}
            >
              {card.icon}
            </div>

            <div className="relative z-10">
              <p className="text-[11px] font-black text-zinc-300/60 uppercase tracking-[0.3em] mb-2 group-hover:text-zinc-400 transition-colors">
                {card.label}
              </p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-12">
        ...
        <div className="xl:col-span-2 space-y-10">
          ...
          >
            <div className="space-y-1">
              ...
              <p className="text-zinc-500 text-sm font-medium">
                Events you are attending this month
              </p>
            </div>
            <Link
              to="/my-tickets"
              className="flex items-center gap-3 text-[11px] font-black text-zinc-500 hover:text-white uppercase tracking-[0.3em] group transition-all bg-white/5 px-6 py-3 rounded-2xl border border-white/10"
            >
              Schedule{" "}
          ...
          <div className="grid gap-8">
            {upcomingBookings.length > 0 ? (
              upcomingBookings.map((booking) => {
                ...
                return (
                  <motion.div
                    ...
                    className="glass-card p-2 rounded-4xl group hover:border-brand-orange/30 transition-all duration-500"
                  >
                    <div className="flex flex-col md:flex-row gap-8 p-4">
                      <div className="relative w-full md:w-72 h-48 rounded-4xl overflow-hidden shrink-0">
                        <img
                      ...
                      <div className="flex-1 flex flex-col justify-between py-4 pr-4">
                        <div className="space-y-6">
                          <h3 className="text-3xl font-black text-white group-hover:text-brand-orange transition-colors line-clamp-1 tracking-tighter">
                            {booking.event.title}
                          </h3>
                          <div className="flex flex-wrap gap-8">
                            <div className="space-y-1">
                              <p className="text-[9px] font-black text-zinc-300/60 uppercase tracking-widest">
                                Date
                              </p>
                              <span className="flex items-center gap-2 text-xs font-bold text-white uppercase tracking-wider">
                                ...
                                {isValid(d) ? format(d, "MMM d, yyyy") : "TBA"}
                              </span>
                            </div>
                            <div className="space-y-1">
                              <p className="text-[9px] font-black text-zinc-300/60 uppercase tracking-widest">
                            ...
                            <div className="space-y-1">
                              ...
                              <span className="flex items-center gap-2 text-xs font-bold text-white uppercase tracking-wider line-clamp-1">
                                <FiMapPin className="text-brand-orange shrink-0" />{" "}
              ...
              >
                <div className="w-32 h-32 bg-zinc-900 rounded-4xl flex items-center justify-center mx-auto mb-10 text-5xl text-zinc-800 shadow-inner">
                  <BsTicketPerforated />
                </div>
                ...
                <p className="text-zinc-500 mb-12 max-w-sm mx-auto font-medium text-lg leading-relaxed">
                  Your portal to the world's most exclusive events awaits. Start
                  your journey today.
                </p>
                <Link
                  to="/events"
                  className="inline-flex items-center gap-4 px-12 py-5 bg-brand-orange text-white rounded-4xl font-black uppercase tracking-[0.2em] hover:scale-105 active:scale-95 transition-all shadow-2xl shadow-brand-orange/40"
                >
                  Explore Collection{" "}
        ...
        <div className="space-y-12">
          ...
          >
            <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-transparent via-brand-orange/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              ...
              {[
                {
                  ...
                  desc: "Exclusive access list",
                },
                {
                  to: "/my-tickets",
                  label: "Digital Hub",
                  icon: <BsTicketPerforated className="text-brand-orange" />,
                  desc: "Manage your passes",
                },
                {
                  to: "/notifications",
                  label: "Live Alerts",
                ...
                <Link
                  key={action.to}
                  to={action.to}
                  className="flex items-center gap-6 p-6 rounded-4xl bg-zinc-900/40 border border-white/5 hover:bg-zinc-800/80 hover:border-brand-orange/20 transition-all group/btn relative overflow-hidden"
                >
                  ...
                  <div>
                    <span className="block text-[11px] font-black text-zinc-500 group-hover/btn:text-white uppercase tracking-widest transition-colors mb-0.5">
                      {action.label}
                    </span>
                    <span className="text-[9px] font-bold text-zinc-300/60 uppercase tracking-tighter group-hover/btn:text-zinc-500">
                      {action.desc}
                    </span>
                  </div>
          ...
          >
            ...
            <div className="absolute inset-0 opacity-20 pointer-events-none group-hover/card:opacity-30 transition-opacity">
              ...
              <div
                className="absolute bottom-[-20%] right-[-20%] w-[100%] h-[100%] bg-brand-secondary/20 rounded-full blur-[80px] animate-pulse-slow"
            ...
            <div className="relative z-10 space-y-12">
              ...
              <div className="space-y-4">
                <p className="text-[10px] font-black text-zinc-300/60 uppercase tracking-[0.4em] pl-1">
                  Access Identity
                </p>
                <p className="text-3xl font-mono text-white tracking-[0.2em] group-hover/card:text-brand-orange transition-colors">
                  #NEXT-8829-X2
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 pt-10 border-t border-white/10">
                <div className="space-y-2">
                  <p className="text-[10px] font-black text-zinc-300/60 uppercase tracking-widest leading-none">
                    Status
                  </p>
                ...
                <div className="text-right space-y-2">
                  ...
                  <p className="text-sm font-black text-transparent bg-clip-text bg-linear-to-r from-amber-400 to-yellow-600 uppercase italic tracking-widest">
                    Diamond
                  </p>
                </div>
              </div>
            ...
            <div className="absolute bottom-0 left-0 w-full h-24 bg-linear-to-t from-brand-orange/10 to-transparent translate-y-full group-hover/card:translate-y-0 transition-transform duration-700" />
          </motion.section>
        </div>
      </div>
    </motion.div>
