          ...
          <AnimatePresence mode="popLayout">
            {notifications.map((n, idx) => (
              <motion.div 
                ...
                className={`group p-6 rounded-[2rem] border transition-all flex gap-5 relative overflow-hidden cursor-pointer ${
                  n.read 
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex flex-wrap justify-between items-start gap-2 mb-1">
                    <h3 className={`font-black text-lg ${n.read ? 'text-zinc-400' : 'text-white'}`}>
                  ...
                  <p className={`text-sm font-medium leading-relaxed ${n.read ? 'text-zinc-500' : 'text-zinc-300'}`}>
                    {n.message}
                  </p>
                </div>
              </motion.div>
