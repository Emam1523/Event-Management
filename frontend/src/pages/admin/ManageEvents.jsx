...
const ManageEvents = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-gray-400 font-medium">
            Create, edit, and keep track of your masterpiece gatherings.
          </p>
        </div>
        <Link
      ...
      {/* Filters & Search */}
      <div className="flex flex-col lg:flex-row gap-6 items-center justify-between bg-white/5 p-6 rounded-4xl border border-white/10 backdrop-blur-xl">
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                            ...
                            src={
                              event.image
                                ? event.image.startsWith("http")
                                  ? event.image
                                  : `${API_ROOT}${event.image}`
                                : "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?ixlib=rb-4.0.3&auto=format&fit=crop&w=1740&q=80"
                            }
                            alt=""
                        ...
                        <div className="min-w-0">
                          <p className="font-black text-white group-hover:text-brand-orange transition-colors truncate">
                            {event.title}
                          </p>
                      ...
                      <div className="space-y-2 max-w-30">
                        ...
                        <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                          <motion.div
                            initial={{ width: 0 }}
                            animate={{
                              width: `${event.capacity > 0 ? ((event._count?.bookings || 0) / event.capacity) * 100 : 0}%`,
                            }}
                            className="h-full bg-linear-to-r from-brand-orange to-orange-400 rounded-full"
                          />
                        </div>
                      </div>
                    </td>
                    <td className="px-8 py-6">
                      <p className="font-black text-white">
                        ৳
                        {(
                          (event._count?.bookings || 0) * event.price
                        ).toLocaleString()}
                      </p>
